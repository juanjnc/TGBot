...
love_list = (
    ...
    'CAACAgQAAxkBAAEDsoBh5DOEHL3D6soHPRYETKn5D84-bAACXQsAAhgwqgXSTVP6Z34hBiME',
    'CAACAgQAAxkBAAEDsoJh5DOOsqeQudIk6aGEAeXcPYmhoQACqAsAAhgwqgXBg0eDcgNqSSME',
    'CAACAgQAAxkBAAEDsoRh5DOVTWJjubiOtwPEVJSJroZjZAACuQsAAhgwqgUceG4oYMn9BiME',
    'CAACAgQAAxkBAAEDsoZh5DOi3Xon-FhKs2ogd4N6-HBtPAACwQwAAhgwqgXUzUT77kS02CME',
    'CAACAgQAAxkBAAEDsohh5DOsAf4sCcnFWLTFhlkgmrRCAgACpAwAAhgwqgXUgjleSj7cyiME',
    'CAACAgIAAxkBAAEDsoph5DQVJm7gFonMwOqQMd8XlpTegAACngADNvEDD-x0PCR-CzHoIwQ',
    'CAACAgIAAxkBAAEDsoth5DQZI6tfOa1wIZncQfQhS5T3TAACpAADNvEDD2fe7i0B20mOIwQ',
...
razas_erdd = [
    ...
    'Rakshasa', 'Saurio', 'Semielfo', 'Semiorco', 'Tiefling', 'Tiefling del pueblo Venheli', 'Vípero',
...
clases_erdd = {
    ...
    'Bardo': ['Colegio del Conocimiento',
              'Colegio del Desafío',
              'Colegio de los Ancestros',
              'Colegio de los Edictos',
              'Colegio de la Naturaleza',
              'Colegio de la Guerra'],
    'Brujo': ['Patrón Ser infernal',
              'Patrón Peregrino',
              'Patrón Dragón'],
    'Clérigo': ['Dominio de la Vida',
                ...
                'Dominio del Destino',
                'Domino de la Confusión',
                'Domino del Océano'],
    'Druida': ['Círculo de la Tierra',
               'Círculo de la Pureza',
               'Círculo de los Huesos',
               'Círculo de la Unidad'],
    'Explorador': ['Cazador',
                   'Buscador de las profundidades',
                   'Vigilante de los Cielos',
                   'Hostigador del bosque profundo',
                   'Buscador del Conocimiento'],
    'Guerrero': ['Campeón',
                 'Custodio',
                 'Segador Maldito',
                 'Incursor de la arena',
                 'Combatiente acrobático',
                 'Guerrero sin miedo'],
    'Hechicero': ['Linaje Dragón',
                  'Linaje del Xion',
    ...
    'Mago': ['Escuela de Evocación',
             ...
             'Artesano Arcano',
             'Escuela de Luz y Fuego',
             'Escuela de la Desolación',
             'Discípulo de los Vientos'],
    'Monje': ['El camino de la mano abierta',
...
trasfondos_erdd = [
    'Acólito', 'Agente de la justicia', 'Artesano', 'Artista', 'Caravanero', 'Colono', 'Combatiente', 'Comerciante',
    'Criminal', 'De buena familia', 'Emisario', 'Erudito', 'Estudioso de los peregrinos', 'Explorador de Vajra',
...
razas_13th_age = [
    'Enano', 'Gnomo', 'SemiElfo', 'Mediano', 'SemiOrco', 'Alto Elfo', 'Mediano', 'Elfo Silvano', 'Elfo Oscuro',
    'Dracónido', 'Forjado', 'Aasimar', 'Tiefling'
]

clases_13th_age = [
    'Bárbaro', 'Bardo', 'Mago Caótico', 'Clérigo', 'Comandante', 'Demonologista', 'Druida', 'Guerrero', 'Monje',
    'Nigromamnte', 'Ocultista', 'Paladín', 'Explorador', 'Pícaro', 'Hechicero', 'Mago', 'Abominación "3pp"',
    'Vidente "3pp"', 'Psiónico "3pp"', 'Salvaje "3pp"', 'Mago de batalla "3pp"', 'Brujo "3pp"'
]

iconos_13th_age = [
    'el Archimago', 'el Destructor', 'la Diabolista', 'el Emperador', 'la Gran Druida', 'el Gran Wyrm Dorado',
